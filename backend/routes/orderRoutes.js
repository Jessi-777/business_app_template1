...
// ✅ Public route - look up order by Stripe session ID (for Success page)
// IMPORTANT: must be defined BEFORE /:id to avoid "session" being treated as an ID
