...
export default function AffiliateSalesReport() {
  ...
  const getTierColor = (tier) => {
    const colors = {
      Trail:  'bg-green-900/30 text-green-400 border-green-700',
      Ridge:  'bg-blue-900/30 text-blue-400 border-blue-700',
      Peak:   'bg-yellow-900/30 text-yellow-400 border-yellow-700',
      Summit: 'bg-purple-900/30 text-purple-400 border-purple-700',
    };
